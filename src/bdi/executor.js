...
import { beliefs, canEnter, canPush } from './beliefs.js';
...
async function stepTowardsTarget(socket, intention) {
    ...
    // crate beliefs can be updated immediately, before the next sensing event, which
    // keeps chained pushes (and the next isStepValid check) consistent.
